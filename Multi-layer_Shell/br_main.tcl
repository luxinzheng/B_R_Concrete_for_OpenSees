...
# Original: integrator DisplacementControl     167         1             1e-3
set _dc_node 167
set _dc_dof 1
set _dc_dincr 1e-3

# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=2
set _dincr $_dc_dincr
set _nstep 2
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
    set ok [analyze 1]
    if {$ok == 0} { continue }
    ...
    integrator DisplacementControl $_dc_node $_dc_dof $_dsub
    ...
    algorithm KrylovNewton; test NormDispIncr 1.0e-4 200 2
    if {$ok == 0} { continue }
    puts "DC step failed: node=$_dc_node dincr=$_dincr step=$_s"
}
record
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=4
set _dincr $_dc_dincr
set _nstep 4
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=8
set _dincr $_dc_dincr
set _nstep 8
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=5
set _dincr $_dc_dincr
set _nstep 5
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=10
set _dincr $_dc_dincr
set _nstep 10
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=9
set _dincr $_dc_dincr
set _nstep 9
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=18
set _dincr $_dc_dincr
set _nstep 18
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=13
set _dincr $_dc_dincr
set _nstep 13
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=25
set _dincr $_dc_dincr
set _nstep 25
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=12
set _dincr $_dc_dincr
set _nstep 12
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=36
set _dincr $_dc_dincr
set _nstep 36
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=24
set _dincr $_dc_dincr
set _nstep 24
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=48
set _dincr $_dc_dincr
set _nstep 48
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=30
set _dincr $_dc_dincr
set _nstep 30
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=60
set _dincr $_dc_dincr
set _nstep 60
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=72
set _dincr $_dc_dincr
set _nstep 72
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=45
set _dincr $_dc_dincr
set _nstep 45
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=90
set _dincr $_dc_dincr
set _nstep 90
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=52
set _dincr $_dc_dincr
set _nstep 52
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=102
set _dincr $_dc_dincr
set _nstep 102
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
...
# Robust displacement control: node=$_dc_node dof=$_dc_dof dincr=$_dc_dincr nsteps=50
set _dincr $_dc_dincr
set _nstep 50
for {set _s 0} {$_s < $_nstep} {incr _s} {
    integrator DisplacementControl $_dc_node $_dc_dof $_dincr
