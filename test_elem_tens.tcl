# ==============================================================================
# Single-element UNIAXIAL TENSION test
# 1m x 1m ShellMITC4, 0.1m thick pure concrete
# Monotonic tension to eps_yy = +0.0005 (well past cracking at ~1e-4)
# ==============================================================================
wipe
...
# ---- Recorders ----
recorder Node -file tens_disp.txt  -time -node 3 4 -dof 1 2 disp
recorder Node -file tens_react.txt -time -node 1 2 -dof 1 2 reaction

# ---- Loading: tension to uy = +0.0005m ----
set target 0.0005
set nSteps 50
...
puts "TENS_TEST: time=[getTime] steps=$nSteps fails=$nFail"
remove recorders
